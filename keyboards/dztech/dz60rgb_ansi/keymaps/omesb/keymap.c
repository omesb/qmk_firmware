...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_ansi(
        ...
        TT(1), KC_LGUI, KC_LALT, KC_SPC, KC_RALT, KC_MPRV, KC_MPLY, KC_MNXT
    ),
    ...
    [1] = LAYOUT_60_ansi(
        ...
        TT(1), _______, _______, _______, _______, _______, _______, RESET
    ),
    ...
    //     MO(1), KC_LGUI, KC_LALT, KC_SPC, OSM(MOD_RALT), _______, _______, _______
    // ),
};
